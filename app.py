...
# ===== CREATORS CARD =====
st.markdown('<div class="team-card-clinical">', unsafe_allow_html=True)

st.markdown("<h3 style='color: #FF6B35; text-align: left;'>Creadores</h3>", unsafe_allow_html=True)

st.markdown("""
<p style='margin: 0; color: #FF6B35; font-size: 1em; line-height: 1.6; text-align: left;'>
<strong>🏥 Institución:</strong> Universidad Autónoma de Chile - Facultad de ingenieria civil informatica<br>
<strong>📊 Proyecto:</strong> OptiCheck (Tema 1 · Equipo 2)<br>
<strong>👨‍⚕️ Integrantes:</strong> Cristian Aguirre, David Pajuero, Patricio Espinal, Celeste Cruces, Amanda Osorio<br>
<strong>🎓 Carrera:</strong> Ingeniería Civil Informática - Primer Año Académico 2026
</p>
""", unsafe_allow_html=True)
...
with tab2:
    ...
    for idx, lamina in enumerate(laminas_ishihara):
        with cols_laminas[idx]:
            st.markdown(
                f"<p style='color:#90CAF9;font-size:0.75em;text-align:center;margin-bottom:4px;'><b>{lamina['id']}</b></p>",
                unsafe_allow_html=True
            )
            st.markdown(f"""
            <div style='
            ...
            '>
                <span style='
                    ...
                    color:{lamina["color_numero"]};
                    font-family:Arial,sans-serif;
                    text-shadow:1px 1px 3px rgba(0,0,0,0.4);
                '>{lamina["numero"]}</span>
            </div>
            <p style='color:#CBD5E1;font-size:0.7em;text-align:center;'>{lamina["pista"]}</p>
            """, unsafe_allow_html=True)

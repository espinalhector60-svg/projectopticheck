...
(function(){
  ...
  var TIPS = [
    '&#128075; Hola, soy <b>OptiBot</b>. Haz clic en cualquier pestana y te explico todo.',
  ...
  var TAB_MSGS = {
    ...
    'Diagn': [
      '&#128300; <b>Diagnostico RD</b>: Esta seccion muestra los <b>criterios clinicos</b> para detectar cada etapa de retinopatia diabetica.<br>&#9888; Esta herramienta es de apoyo. El diagnostico final lo emite siempre un oftalmologo.',
      '&#128203; <b>Las 4 etapas de la RD</b>:<br>&#128313; <b>Leve</b>: microaneurismas aislados<br>&#128313; <b>Moderada</b>: hemorragias y exudados<br>&#128313; <b>Grave</b>: isquemia retinal extensa<br>&#128313; <b>Proliferativa</b>: neovasos, riesgo de ceguera',
      '&#128065; <b>Señales en la retina</b>: microaneurismas (puntos rojos), hemorragias, exudados duros amarillos y edema macular son los primeros signos que la IA puede detectar.',
    ],
    'RD': [
  ...
  var CTX = {
    checkbox: [
      '&#128203; Casilla seleccionada. Cada opcion activa una funcion diferente del analisis.',
      '&#9989; ¡Perfecto! Sigue explorando. Puedo explicarte cualquier seccion.',
      '&#128270; Ajustando configuracion. Estos parametros afectan el resultado del analisis.',
    ],
    upload: [
      '&#128247; &#128513; ¡Imagen recibida! La IA analizara nitidez, iluminacion y calidad retinal.',
      '&#128065; Procesando imagen... En unos segundos veras el resultado del analisis de calidad.',
    ],
    button: [
    ...
    slider: [
      '&#127922; Ajustando parametro. El valor elegido influye en el resultado final.',
    ],
    idle: [
      '&#128276; ¿Necesitas ayuda? Haz clic en cualquier pestana y te explico esa seccion.',
      '&#128161; Dato curioso: la diabetes afecta al 8.5% de la poblacion adulta mundial.',
      '&#128300; El fondo de ojo es la unica parte del cuerpo donde los vasos se ven directo.',
      '&#128104; ¿Sabias que el 90% de la perdida de vision por RD es prevenible con diagnostico temprano?',
    ],
  };
  ...
  function resetAuto() {
    clearTimeout(autoT);
    autoT = setTimeout(function() { if (isOpen) { showTip(cur + 1); resetAuto(); } }, 16000);
  }
  ...
  var observer = new MutationObserver(function(mutations) {
    mutations.forEach(function(m) {
      m.addedNodes.forEach(function(node) {
        ...
        if (text.indexOf('Puntaje de Nitidez') > -1 || text.indexOf('APROBADA') > -1 || text.indexOf('RECHAZADA') > -1) {
          displayMsg('&#128202; <b>Resultado listo.</b> Revisa el puntaje de nitidez. Si la imagen fue rechazada, intenta mejorar la iluminacion o el encuadre y vuelve a subirla.');
          if (!isOpen) open_();
        }
      });
    });
  ...
  var QA = [
    { k:['que es','retinopatia','rd','enfermedad','diabetes ocular'],
      a:'&#128065; La <b>Retinopatia Diabetica (RD)</b> es una complicacion de la diabetes que daña los vasos sanguineos de la retina. Sin tratamiento puede causar ceguera. Tiene 4 etapas: leve, moderada, grave y proliferativa.' },
    { k:['etapas','fases','grados','estadios','cuantas etapas'],
      a:'&#128300; Las <b>4 etapas de la RD</b>:<br>1. <b>Leve</b>: microaneurismas aislados<br>2. <b>Moderada</b>: hemorragias y exudados<br>3. <b>Grave</b>: isquemia retinal extensa<br>4. <b>Proliferativa</b>: neovasos y alto riesgo de ceguera.' },
    { k:['sintomas','señales','signos','como saber','noto','siento'],
      a:'&#9888; En etapas tempranas la RD <b>no tiene sintomas visibles</b>. Por eso los controles visuales regulares son esenciales. En etapas avanzadas puede haber vision borrosa, manchas flotantes o perdida de vision.' },
    { k:['prevencion','prevenir','evitar','cuidar','proteger'],
      a:'&#9989; Para prevenir la RD: <b>controla tu glucosa en sangre</b>, presion arterial y colesterol. Un control estricto reduce el riesgo hasta un <b>76%</b>. Ademas: alimentacion saludable, ejercicio y examenes anuales.' },
    { k:['microaneurisma','microaneurismas','puntitos rojos'],
      a:'&#128300; Los <b>microaneurismas</b> son pequenas dilataciones en los vasos capilares de la retina. Son la primera señal de RD (etapa leve). Aparecen como puntos rojos pequenos en el fondo de ojo.' },
    { k:['hemorragia','hemorragias','sangrado','sangre'],
      a:'&#129656; Las <b>hemorragias retinales</b> ocurren cuando los vasos dañados sangran dentro del ojo. Pueden ser intraretinales (etapa moderada/grave) o prerretinales (etapa proliferativa).' },
    { k:['exudado','exudados','manchas amarillas','depositos'],
      a:'&#128161; Los <b>exudados duros</b> son depositos de lipidos y proteinas en la retina. Aparecen como manchas amarillentas. Indican daño vascular y posible edema macular.' },
    { k:['macula','macular','edema macular','fovea'],
      a:'&#128065; La <b>macula</b> es la zona central de la retina responsable de la vision nitida. El <b>edema macular diabetico</b> es la acumulacion de liquido en esa zona y es la principal causa de perdida de vision en RD.' },
    { k:['neovasos','neovascularizacion','vasos nuevos','proliferativa'],
      a:'&#128308; La <b>neovascularizacion</b> ocurre en la etapa proliferativa. El ojo crea nuevos vasos fragiles y anormales que pueden sangrar o desprender la retina. Es la etapa mas grave.' },
    { k:['retina','que es la retina','para que sirve'],
      a:'&#128065; La <b>retina</b> es la capa interna del ojo que convierte la luz en señales nerviosas. Contiene millones de fotorreceptores (conos y bastones). El nervio optico transmite esas señales al cerebro.' },
    { k:['nervio optico','disco optico','papila'],
      a:'&#128300; El <b>nervio optico</b> conecta la retina con el cerebro. El <b>disco optico</b> (o papila) es donde el nervio sale del ojo. Es visible en el fondo de ojo como una zona clara y redonda.' },
    { k:['foto','imagen','calidad','nitidez','subir','tomar'],
      a:'&#128247; Para una buena imagen retinal:<br>&#10003; Buena iluminacion uniforme<br>&#10003; Fondo de ojo centrado y visible<br>&#10003; Sin reflejos ni sombras<br>&#10003; Formato JPG o PNG<br>&#10003; Camara limpia y estable' },
    { k:['rechazada','rechazo','mala foto','no sirve','que hago'],
      a:'&#128270; Si la foto fue <b>rechazada</b>: verifica la iluminacion, centra mejor el fondo de ojo, limpia la camara y evita el movimiento. Vuelve a intentarlo. La IA te dira el motivo del rechazo.' },
    { k:['puntaje','score','nitidez','resultado','que significa'],
      a:'&#128202; El <b>puntaje de nitidez</b> mide la calidad de la imagen. Un puntaje alto (verde) indica imagen util para diagnostico. Bajo (rojo) indica que la foto debe retomarse antes de enviarla al oftalmologo.' },
    { k:['clip','openai','ia','inteligencia artificial','modelo'],
      a:'&#129504; Usamos <b>CLIP de OpenAI</b> para clasificar semanticamente las imagenes retinales, combinado con <b>OpenCV</b> para medir nitidez y calidad. Todo se procesa localmente (Edge AI), sin enviar datos a internet.' },
    { k:['opticheck','sistema','aplicacion','app','como funciona'],
      a:'&#9881; <b>OptiCheck</b> es un sistema Edge AI que analiza imagenes de fondo de ojo en tiempo real. Detecta la calidad de la foto antes de enviarla al oftalmologo, reduciendo un 78% las fotos rechazadas en zonas rurales de Chile.' },
    { k:['costo','precio','cuanto cuesta','economico'],
      a:'&#128176; El costo por imagen analizada es aprox. <b>$95 CLP</b>. Comparado con el costo de una recita (300-500% mas), el ahorro es significativo. A escala regional, representa millones en ahorro al sistema de salud.' },
    { k:['tratamiento','tratar','como se trata','cura'],
      a:'&#128138; El tratamiento de la RD depende de la etapa:<br>&#128313; <b>Laser (fotocoagulacion)</b>: para etapas avanzadas<br>&#128313; <b>Inyecciones intravitreas</b>: anti-VEGF para edema macular<br>&#128313; <b>Cirugia vitreoretinal</b>: para desprendimiento de retina<br>La mejor "cura" es la prevencion.' },
    { k:['glucosa','azucar','hemoglobina','hba1c','control'],
      a:'&#128137; Mantener la <b>HbA1c por debajo del 7%</b> reduce significativamente el riesgo de RD. El control glucemico es el factor mas importante en la prevencion y progresion de la enfermedad.' },
    { k:['oftalmologo','medico','especialista','cuando ir','consulta'],
      a:'&#128104; Toda persona con diabetes debe hacerse un <b>examen de fondo de ojo anual</b>. Si ya tienes RD diagnosticada, la frecuencia depende de la etapa. Ante cualquier cambio visual repentino, consulta de inmediato.' },
    { k:['hola','buenos dias','buenas','saludos','hi'],
      a:'&#128075; ¡Hola! Soy <b>OptiBot</b>, tu asistente en OptiCheck. Puedo explicarte sobre retinopatia diabetica, como usar la app, interpretar resultados o cualquier duda sobre el ojo. ¿Que quieres saber?' },
    { k:['gracias','muchas gracias','ok gracias','perfecto'],
      a:'&#128513; ¡Con gusto! Cualquier otra pregunta, aqui estoy. Recuerda explorar las pestanas de la app para ver todo lo que OptiCheck puede hacer por ti.' },
    { k:['ayuda','no entiendo','explica','no se','duda'],
      a:'&#128161; Puedo ayudarte con:<br>&#128313; ¿Que es la retinopatia diabetica?<br>&#128313; Como subir una buena imagen<br>&#128313; Como interpretar los resultados<br>&#128313; Las etapas de la enfermedad<br>&#128313; Como funciona la IA<br>&#128073; ¡Escribe tu pregunta!' },
  ];
  ...
  function findAnswer(q) {
    ...
    if (bestScore === 0) {
      return '&#128533; No encontre una respuesta exacta para eso. Intenta preguntar sobre: <b>etapas de la RD, sintomas, prevencion, como subir una foto, tratamientos</b> o cualquier termino medico que veas en la app.';
    }
    return '<span class="ob-ans-tag">&#129504; OptiBot responde</span><br>' + best;
  }
  ...
  if (inputEl) {
    ...
    inputEl.addEventListener('focus', function() { clearTimeout(autoT); });
  }
